...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Dawid\IICE-PYTHON\Automatization-in-the-search-for-correct-websites'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Dawid\IICE-PYTHON\Automatization-in-the-search-for-correct-websites\Scripts\deactivate.nu'
